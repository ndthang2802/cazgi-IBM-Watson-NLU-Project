...
app.get("/text/emotion", (req,res) => {
    ...
    naturalLanguageUnderstanding.analyze(analyzeParams)
    .then(analysisResults => {
        //Retrieve the emotion and return it as a formatted json
        result = JSON.stringify(analysisResults.result.keywords[0].emotion,null,2)
...
app.get("/text/sentiment", (req,res) => {
    ...
    naturalLanguageUnderstanding.analyze(analyzeParams)
    .then(analysisResults => {
        //Retrieve the sentiment and return it as a formatted json
        result = JSON.stringify(analysisResults.result.keywords[0].sentiment,null,2)
        return res.send(result);
    })
    .catch(err => {
        return res.send("Could not do desired operation "+err);
